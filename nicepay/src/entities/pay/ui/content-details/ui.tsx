...
import { CollapseCustomMock, ContentDetailsPaymentData } from "@entities/pay/mock"
        ...
        <>
            <div className="flex flex-col mt-3">
                <div className="text-base font-semibold text-black dark:text-white mb-4">
                    Переведите {data.price} ₽ по указанным реквизитам
                </div>
                        ...
                        <div className="flex items-center">
                            <div className="flex items-center text-base font-semibold text-black dark:text-white leading-none">
                                ...
                                <div className="ml-5 w-full">
                                    <div className="text-sm font-bold text-black dark:text-white mb-2">{data.transferToWhere}</div>
                                    <div className="text-base text-amber-600 font-extrabold dark:text-amber-400">{data.detailsPay}</div>
                                </div>
                            </div>
                        </div>
                    </div>
                </div>
                <CollapseCustom data={CollapseCustomMock} />
                ...
                <div className="flex items-center gap-x-1 opacity-80">
                    ...
                    <div className="text-xs text-amber-600 dark:text-amber-400 leading-none font-normal">
                        {ContentDetailsPaymentData[0].warning}
                    </div>
                </div>
